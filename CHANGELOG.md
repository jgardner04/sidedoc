...
- **SmartArt support:** Detect SmartArt diagrams, extract cached images, and parse node text into metadata. _SmartArt rebuilds as a raster placeholder; full SmartArt round-trip is tracked separately._
