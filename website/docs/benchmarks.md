...
Measure and compare document processing pipelines for AI workloads.

## Overview

The benchmark suite evaluates token efficiency, format fidelity, and cost when using different approaches to prepare documents for LLM processing.
...
| `edit_single` | Single-turn document editing |
| `edit_multiturn` | Multi-turn conversational editing |
...
- Install LibreOffice: [libreoffice.org/download](https://www.libreoffice.org/download/)
- Install Poppler: [github.com/oschwartz10612/poppler-windows](https://github.com/oschwartz10612/poppler-windows/releases)
...
### Quick Test with Synthetic Documents
